...
def parse_publications_by_location(location_id, date_from, date_till, max_items=None):
...
if __name__ == '__main__':
    ...
    result = parse_publications_by_location(location_id=location_id, date_from=date_from, date_till=date_till, max_items=40)
